"""Random WH40k quotes. FOR THE EMPEROR!"""
...
THOUGHTS = [
    ...
    "Consider the Predator tank. Let your soul be armoured with Faith, driven on the tracks of Obedience which overcome all obstacles, and armed with the three great guns of Zeal, Duty and Purity.",
